...
const DIVISIONS: Division[] = [
  {
    ...
    dates: ["6/27", "6/28"],
    corps: [
      { name: "Blue Devils", shortName: "BD", color: "#3B82F6", scores: { "6/27": 75.650, "6/28": 77.250 } },
      { name: "Blue Knights", shortName: "BK", color: "#6366F1", scores: { "6/27": 72.650, "6/28": 72.650 } },
      { name: "Genesis", shortName: "GEN", color: "#F59E0B", scores: { "6/27": 67.850, "6/28": 69.400 } },
      { name: "Phantom Regiment", shortName: "PR", color: "#EF4444", scores: { "6/27": 67.550, "6/28": 69.000 } },
      { name: "Troopers", shortName: "TR", color: "#10B981", scores: { "6/27": 60.350, "6/28": 62.150 } },
    ],
  },
  {
    label: "Open Class",
  ...
  },
  {
    ...
    dates: ["6/27"],
    corps: [
      { name: "Reading Buccaneers", shortName: "RB", color: "#DC2626", scores: { "6/27": 80.950 } },
      { name: "Hawthorne Caballeros", shortName: "HC", color: "#7C3AED", scores: { "6/27": 78.700 } },
      { name: "Hurricanes", shortName: "HUR", color: "#0EA5E9", scores: { "6/27": 76.800 } },
      { name: "Bushwackers", shortName: "BW", color: "#F97316", scores: { "6/27": 71.350 } },
    ],
  },
];
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/30">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-lg flex items-center justify-center font-bold text-[10px] text-white"
                style={{ background: "linear-gradient(135deg, #1b6900, #2d8a12)" }}>DCI</div>
              <span>&copy; {new Date().getFullYear()} DCI Scores</span>
            </div>
